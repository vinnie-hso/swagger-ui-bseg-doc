...
if [ "$SWAGGER_JSON_URL" ]; then
  sed -i "s|https://raw.githubusercontent.com/vinnie-hso/swagger-ui-bseg-doc/main/swagger.json|$SWAGGER_JSON_URL|g" $INDEX_FILE
...
if [[ -f "$SWAGGER_JSON" ]]; then
  ...
  sed -i "s|https://raw.githubusercontent.com/vinnie-hso/swagger-ui-bseg-doc/main/swagger.json|$REL_PATH|g" $INDEX_FILE
